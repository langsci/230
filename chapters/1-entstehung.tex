...
An Abbildung \ref{wals} aus dem \hervor{World Atlas of Language Structures (WALS)}\footnote{\url{https://wals.info/feature/37A\#2/25.5/148.2}, zuletzt aufgerufen am 31.10.2018.} lassen sich  indirekt die groben Stufen der Artikelentwicklung -- vom ursprünglichen Demonstrativ zu einem affigierten Artikel -- ablesen. 
...
etwa [\object{am} V-\object{en sein}] (Flick 2015) oder die Ditransitivkonstruktion [NP\textsubscript{Nom} V NP\textsubscript{Dat} NP\textsubscript{Acc}] (Goldberg 2006)ist ein hoher Gebrauch unterschiedlicher Types verantwortlich, da sich durch das wiederholte Parsen ein schematisches Muster als überdachende Abstraktion kognitiv einschleifen kann.\footnote{Es sei an dieser Stelle angemerkt, dass Frequenzwerte natürlich nur auf der Tokenebene gemessen werden können, d.h. es lassen sich keine Frequenzaussagen über die abstrakte Konstruktion [Definitartikel\,+\,N] machen, sondern nur über die konkret realisierten Mikrokonstruktionen, etwa \object{das Kind}.} 
