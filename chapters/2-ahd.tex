...
\begin{exe}
	...
	\begin{xlist} \label{ex:sem-def}\raggedright
		...
		\ex \label{ex:sem-def2}  Mein Rechner spinnt. \object{Die Tastatur} funktioniert nicht mehr. \\ Assoziativ-anaphorisch: Eindeutige Identifikation durch metonymische 1:1-Be"-zie"-hung von Rechner und Tastatur
		\end{xlist}
\end{exe}
\noindent
