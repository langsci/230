...
\begin{figure}
\todo[inline]{Check where this graph comes from}
\begin{center}
...
% %   \includegraphics[width=9cm]{images/croft-construction-neu.jpg}
  ...
  \path let \p1 = (Konstruktion.west), \p2  = (Eig1) in node [inner sep=0pt,anchor=west] at (\x1,\y2)
    (Form) {Form};
  \path let \p1 = (Konstruktion.west), \p2  = (midway) in node [text width=5cm,inner sep=0pt,anchor=west] at (\x1,\y2)
    (Korrespondenz) {symbolische\\Korrespondenz};
  \path let \p1 = (Konstruktion.west), \p2  = (Eig2) in node [text width=5cm,inner sep=0pt,anchor=west] at (\x1,\y2)
...
% %   \includegraphics[width=12cm]{images/type-token-entrenchment-neu-sw.jpg}
  ...
  \begin{center}
  \begin{forest} for tree={edge=dotted}
