...
\begin{tabular}{@{}lllll@{}}
\toprule
\textbf{\begin{tabular}[c]{@{}l@{}}Individuiert\end{tabular}} & \textbf{Nicht-individuiert} &  &  &  \\ \midrule
Eigenname                                                              		   & Gattungsname                              &  &  &  \\
Mensch, belebt                                                                 & unbelebt                              &  &  &  \\
konkret                                                                        & abstrakt                              &  &  &  \\
Singular                                                                       & Plural                                &  &  &  \\
zählbar                                                                        & nicht zählbar                         &  &  &  \\
referentiell, definit                                                          & nicht-referentiell                    &  &  &  \\ \bottomrule
\end{tabular}
\caption{Faktoren für die Individualität \parencite[253]{Hopper1980}}
\label{tab:indi}
\end{table}
\noindent
...
\begin{tabular}{@{}llcc@{}}
\toprule
{\bf Substantivklasse} & {\bf Beispiel}   & \multicolumn{1}{l}{{\bf Begrenztheit}} & \multicolumn{1}{l}{{\bf Interne Struktur}} \\ \midrule
Individuum             & {\it Buch}       & +                                      & -                                          \\
Kollektivum            & {\it Mannschaft} & +                                      & +                                          \\
Agglomerat             & {\it Bücher}     & -                                      & +                                          \\
Substanz (=Massennomen) & {\it Gold}       & -                                      & -                                          \\\bottomrule
\end{tabular}
...
\caption {Seinsarten im Deutschen aus \textcite[104]{Zifonun2012}}
\label{abb:zifonun-seinsarten}
\end{center}
\end{figure}
