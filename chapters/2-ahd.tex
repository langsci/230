...
\begin{itemize} 
		\item[a)] \label{poss} Possessiva: \object{m\={i}n, d\={i}n, s\={i}n} etc.
		\item[b)] \label{dieser} Demonstativa: \object{dër, dëser, jener, solih/solicher, sëlb, der samo}
\end{itemize}
...
\begin{tabular}{@{}lllll@{}}
\toprule
                  &               & \multicolumn{1}{l}{\textbf{Maskulinum}}  & \multicolumn{1}{l}{\textbf{Neutrum}}     & \multicolumn{1}{l}{\textbf{Femininum}}       \\ \midrule
\textbf{Sg.} & \textbf{Nom.} & \textit{blinto}                          & \textit{blinta}                          & \textit{blinta}                              \\
                  & \textbf{Gen.} & \textit{blinten, -in}                    & \textit{blinten, -in}                    & \textit{blintun}                             \\
                  & \textbf{Dat.} & \textit{blinten, -in}                    & \textit{blinten, -in}                    & \textit{blintun}                             \\
                  & \textbf{Akk.} & \textit{blinton, -un}                    & \textit{blinta}                          & \textit{blintun}                             \\
\textbf{Pl.}   & \textbf{Nom.} & \textit{blinton, -un}                    & \textit{blintun, -on}                    & \textit{blintun}                             \\
                  & \textbf{Gen.} & \textit{blintono}                        & \textit{blintono}                        & \textit{blintono}                            \\
                  & \textbf{Dat.} & \textit{blintom, -on}                    & \textit{blintom, -on}                    & \textit{blintom, -on}                        \\
                  & \textbf{Akk.} & \textit{blinton, -un}                    & \textit{blintun, -on}                    & \textit{blintun}                             \\
                  ...
                  & \textbf{Nhd.}          & \multicolumn{1}{l}{der blinde Gast}      & \multicolumn{1}{l}{das blinde Lamm}      & \multicolumn{1}{l}{die blinde Königin}       \\ \bottomrule
\end{tabular}}
...
\begin{tabular}{@{}lllll@{}}
\toprule
\textbf{}         & \textbf{}              & \multicolumn{1}{l}{\textbf{Maskulinum}} & \multicolumn{1}{l}{\textbf{Neutrum}} & \multicolumn{1}{l}{\textbf{Femininum}} \\ \midrule
\textbf{Sg.} & \textbf{Nom.}          & \textit{blint/blinter}                  & \textit{blint/blintaz}               & \textit{blint/blint(i)u}               \\
\textbf{}         & \textbf{Gen.}          & \textit{blintes}                        & \textit{blintes}                     & \textit{blintera}                      \\
\textbf{}         & \textbf{Dat.}          & \textit{blintemu, -emo (amu)}           & \textit{blintemu, -emo (amu)}        & \textit{blintera}                      \\
\textbf{}         & \textbf{Akk.}          & \textit{blintan}                        & \textit{blint/blintaz}               & \textit{blinteru, -ero}                \\
\textbf{Pl.}   & \textbf{Nom.}          & \textit{blinte/blint}                   & \textit{blintiu/blint}               & \textit{blinto/blint}                  \\
\textbf{}         & \textbf{Gen.}          & \textit{blintero}                       & \textit{blintero}                    & \textit{blintero}                      \\
\textbf{}         & \textbf{Dat.}          & \textit{blintem, -en}                   & \textit{blintem, -en}                & \textit{blintem, -en}                  \\
\textbf{}         & \textbf{Akk.}          & \textit{blinte}                         & \textit{blint(i)u}                   & \textit{blinto}                        \\
                  & \textbf{}              & \multicolumn{1}{l}{}                    & \multicolumn{1}{l}{}                 & \multicolumn{1}{l}{}                   \\
                  & \textbf{Bsp.} & \textit{blint gast}                     & \textit{blint lamb}                  & \textit{blinto kuningin}               \\
                  & \textbf{Nhd.}          & ein blinder Gast                        & ein blindes Lamm                     & die blinde Königin                     \\ \bottomrule
\end{tabular}}
\caption{Starke Adjektivdeklination (a/-o-Stämme) [- individualisierend] am Beispiel von \herkur{blint} \extrans{blind} \parencite[220]{Braune2004}}
\label{tab:stark-adj}
\end{table}
...
\textit{ther}    & 31                     & 11                         & 1                        \\
kein Artikelwort & 135                    & 0                          & 15                       \\ \bottomrule
\end{tabular}
...
\subparagraph*{(a) Semantik des Bezugsnomens} 
\enlargethispage{5ex}
...
\subparagraph*{(b) Individualisierende Attribute und Determinierer} 
...
\subparagraph*{(c) Syntaktische Funktion der NP} 
...
\subparagraph*{(d) Definitheitsumgebungen im Satz} 
...
\subparagraph*{(e) Pragmatische vs. semantische Definitheitskontexte} 
\enlargethispage{5ex}
